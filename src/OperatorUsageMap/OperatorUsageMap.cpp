...
OperatorUsageMap::OperatorUsageMap() {
    ...
    operator_usage_map.map["superposition"] =
            ...
            "        if the coefficients of all the kets are floats, then the superposition corresponds to a vector in some abstract space\n"
            ...
            "        and of course we have a similarity measure, that compares the similarity of two superpositions\n"
            ...
            "        -- which is also a mathematical multi-set:\n"
            ...
            "        -- we even have a built in operator to map positive integers to their factors:\n"
            ...
            "        -- eg, (0.1, 7.2, 5, 0.09, 3.4) could be represented as:\n"
